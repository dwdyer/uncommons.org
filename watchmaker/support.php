    ...
    <div id="container">
      <?php readfile('header.html'); ?>
        ...
        <p>
          ...
          is not always ideal but this is still the first place you should look.  Try the
          <a href="/manual/index.html">user manual</a> and the Javadoc <a href="/api/index.html">API documentation</a>.
