...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  <head>
    <title>Watchmaker Framework - Download</title>
  ...
  <body class="yui-skin-sam">
    <div id="container">
      <?php readfile('header.html'); ?>
        ...
        <h2>Maven Users</h2>
        <p>
          Recent versions of the Watchmaker Framework are available from the
          <a href="https://maven2-repository.dev.java.net/">Java.net Maven 2 repository</a>.
        </p>
        <h2>Source Code</h2>
        <p>
